            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className={`p-4 border text-left flex flex-col justify-between h-36 rounded-[2px] transition-all ${
                    role === 'job_seeker'
                ...
                >
                  ...
                  <div>
                    <span className="block font-bold text-sm tracking-wider uppercase text-slate-900">Job Seeker</span>
                    <span className="block text-[10px] text-gray-400 mt-1 leading-normal">Build and customize portfolios from resumes.</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div>
                    <span className="block font-bold text-sm tracking-wider uppercase text-slate-900">Recruiter</span>
                    <span className="block text-[10px] text-gray-400 mt-1 leading-normal">Upload and screen resumes against job posts.</span>
                  </div>
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-[10px] font-bold uppercase tracking-wider text-gray-500 mb-1">
                    Full Name
                  </label>
                  <input
                    id="name"
